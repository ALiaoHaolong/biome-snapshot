...
本项目使用 <a href="https://github.com/ALiaoHaolong/slots-checker/blob/master/LICENSE" target="_blank" rel="noreferrer" class="vp-external-link-icon">Apache License 2.0</a>。
